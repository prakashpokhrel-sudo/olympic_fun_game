...
<head>
    ...
    <link rel=stylesheet type=text/css href="/folder1/css/layerslider.css">
    <script src="/folder1/js/vendor/modernizr.js"></script>
</head>
<body><!--[if lt IE 10]>
...
<div class=wrapper>
    <header class=header-main>
        <div class=header-upper>
            <div class=container>
                <div class=row>
                    <ul>
                        <li><a href="{{route('register')}}" style="color: white;">Signup</a></li>
                        <li><a href="{{route('login')}}" style="color: white;" ></i> <span>login</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class=banner id=layerSlider style="width: 100%;">
        <div class=ls-slide data-ls="transition3d: 33,15; slidedelay: 8000 ; durationin:0;"><img
                src="/folder1/images/banner/background01.jpg" class=ls-bg alt="Slide background">
            ...
            <div class="ls-l layercontent01" style="top: 50%; left: 50%; z-index:4;"
                 data-ls="offsetxin:left; offsetxout:right; durationin: 4000; parallaxlevel: 8;"><img
                    src="/folder1/images/banner/player.png" alt=innerimage class=img-responsive
                    style="max-width: 100% !important ;"></div>
            <img src="/folder1/images/banner/ball.png" alt=innerimage class="ls-l layercontent02" style=z-index:5;
                 data-ls="offsetxin: right; offsetxout:left; rotatein:-360; easingin: easeoutquart; durationin: 4000; delayin: 250; parallaxlevel: -5;">
            <img src="/folder1/images/banner/front_particles.png" alt=particles class=ls-l style="z-index:3; left:0;"
                 data-ls="offsetxin: left; offsetxout:left; scalexin:50; easingin: easeoutquart; durationin: 3000; delayin: 250;">
            <img src="/folder1/images/banner/back_particles.png" alt=particles class=ls-l style="z-index:3; left:50%;"
...
<script src="/folder1/js/vendor/vendor.js"></script>
<script src="/folder1/js/main.js"></script>
</body>
